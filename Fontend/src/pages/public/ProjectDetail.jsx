            ...
            <div style={{ marginBottom:'var(--space-6)' }}>
              ...
              <div style={{ display:'flex', gap:'var(--space-2)', flexWrap:'wrap' }}>
                {project.tech_stack.map(t => (
                  <span key={t} style={{ background:'var(--color-primary-bg)', color:'var(--color-primary)', border:'1px solid rgba(124, 58, 237,.2)', padding:'4px 12px', borderRadius:'var(--radius-full)', fontSize:'var(--text-xs)', fontWeight:'var(--font-semibold)' }}>{t}</span>
                ))}
              </div>
            </div>
          )}
