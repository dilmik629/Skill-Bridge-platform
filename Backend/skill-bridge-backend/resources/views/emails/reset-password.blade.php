          ...
          <tr>
            <td style="padding:32px;">
              ...
              <p style="color:#374151;font-size:15px;line-height:1.6;">
                We received a request to reset your SkillBridge password. Click the button below to choose a new one.
              </p>
              ...
              <p style="color:#6b7280;font-size:13px;">This link expires in 60 minutes. If you didn't request a password reset, you can safely ignore this email.</p>
            </td>
          </tr>
        </table>
      </td>
